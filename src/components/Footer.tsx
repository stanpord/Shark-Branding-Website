...
const socials = [
  {
    label: "Facebook",
    href: "https://www.facebook.com/sharkbrandingsolutions",
    icon: (
  ...
  {
    label: "Instagram",
    href: "https://www.instagram.com/sharkbrandingsolutions",
    icon: (
  ...
  {
    label: "X",
    href: "https://x.com/SharkBranding",
    icon: (
      <svg width="18" height="18" viewBox="0 0 24 24" fill="currentColor" aria-hidden="true">
  ...
  {
    label: "YouTube",
    href: "https://www.youtube.com/@sharkbrandingsolutions",
    icon: (
      <svg width="18" height="18" viewBox="0 0 24 24" fill="currentColor" aria-hidden="true">
