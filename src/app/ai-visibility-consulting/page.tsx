...
export default function AiVisibilityConsultingPage() {
  return (
    <>
      ...
      {/* Hero */}
      <section className="bg-[#07141a] min-h-[88vh] flex flex-col items-center justify-center text-center px-6 pt-24 pb-20">
        <div className="max-w-[760px] mx-auto">
          <p className="text-[#18b5d8] text-[13px] font-semibold tracking-[0.2em] uppercase mb-8">
            AI Visibility Consulting · Tampa Bay
          </p>
          <h1 className="display-hero text-white mb-6" style={{ textWrap: "balance" }}>
            Get your business recommended
            <br />
            <span className="text-[#18b5d8]">by ChatGPT and Gemini.</span>
          </h1>
          <p className="lead-airy text-white/65 max-w-[560px] mx-auto mb-12" style={{ textWrap: "balance" }}>
      ...
      <section className="bg-white py-24 px-6">
        <div className="max-w-[720px] mx-auto">
          ...
          <p className="lead-airy text-[#444] mb-6">
          ...
          <p className="lead-airy text-[#444] mb-6">
            AI Overviews now appear on more than 60% of Google searches. Perplexity and
          ...
          <p className="lead-airy text-[#444]">
      ...
      <section className="bg-[#0a0a0a] py-24 px-6">
        <div className="max-w-[720px] mx-auto text-center">
          ...
          <p className="lead-airy text-white/65 mb-12">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 text-left mb-12">
            {[
              ...
              <div key={item.label} className="bg-white/5 border border-white/10 rounded-[14px] p-6">
      ...
      <section className="bg-white py-24 px-6">
        <div className="max-w-[720px] mx-auto">
          ...
          <h2 className="display-lg text-[#0a0a0a] mb-12" style={{ textWrap: "balance" }}>
      ...
      <section className="bg-[#18b5d8] py-24 px-6 text-center">
        <div className="max-w-[560px] mx-auto">
          ...
          <p className="lead-airy text-black/65 mb-10">
            ...
            you don&rsquo;t, and what to fix first.
          </p>
          <div className="flex flex-wrap items-center justify-center gap-4">
            <Link
              href="/free-report"
