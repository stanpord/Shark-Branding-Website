...
export const metadata: Metadata = {
  ...
  alternates: { canonical: 'https://shark-ai-solutions.com/aiemployees/contractors' },
  openGraph: {
    title: 'AI Employees for Contractors | Shark AI Solutions',
    ...
    url: 'https://shark-ai-solutions.com/aiemployees/contractors',
    type: 'website',
    images: [{ url: 'https://shark-ai-solutions.com/logo.webp', width: 1200, height: 630, alt: 'AI Employees for Contractors | Shark AI Solutions' }],
  },
}
...
const structuredData = {
  ...
  '@graph': [
    {
      '@type': 'Service',
      '@id': 'https://shark-ai-solutions.com/aiemployees/contractors#service',
...
const breadcrumbData = {
  ...
  itemListElement: [
    ...
    { '@type': 'ListItem', position: 3, name: 'AI Employees for Contractors', item: 'https://shark-ai-solutions.com/aiemployees/contractors' },
  ],
}
