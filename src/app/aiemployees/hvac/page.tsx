...
export const metadata: Metadata = {
  ...
  alternates: { canonical: 'https://shark-ai-solutions.com/aiemployees/hvac' },
  openGraph: {
    title: 'AI Employees for HVAC Companies | Shark AI Solutions',
    ...
    url: 'https://shark-ai-solutions.com/aiemployees/hvac',
    type: 'website',
    images: [{ url: 'https://shark-ai-solutions.com/logo.webp', width: 1200, height: 630, alt: 'AI Employees for HVAC Companies | Shark AI Solutions' }],
  },
}
...
const structuredData = {
  ...
  '@graph': [
    {
      '@type': 'Service',
      '@id': 'https://shark-ai-solutions.com/aiemployees/hvac#service',
...
const breadcrumbData = {
  ...
  itemListElement: [
    ...
    { '@type': 'ListItem', position: 3, name: 'AI Employees for HVAC Companies', item: 'https://shark-ai-solutions.com/aiemployees/hvac' },
  ],
}
