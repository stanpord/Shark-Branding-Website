...
export const metadata: Metadata = {
  ...
  alternates: { canonical: 'https://shark-ai-solutions.com/aiemployees' },
  ...
  openGraph: {
    ...
    type: 'website',
    images: [{ url: 'https://shark-ai-solutions.com/logo.webp', width: 1200, height: 630, alt: 'AI Employees | Shark AI Solutions' }],
  },
}
...
const structuredData = {
  ...
  '@graph': [
        ...
        itemListElement: [
          {
            ...
            itemOffered: {
              '@type': 'Service',
              '@id': 'https://shark-ai-solutions.com/aiemployees#chat-receptionist',
          ...
          },
          {
            ...
            itemOffered: {
              '@type': 'Service',
              '@id': 'https://shark-ai-solutions.com/aiemployees#voice-receptionist',
          ...
          },
          {
            ...
            itemOffered: {
              '@type': 'Service',
              '@id': 'https://shark-ai-solutions.com/aiemployees#reputation-specialist',
          ...
          },
          {
            ...
            itemOffered: {
              '@type': 'Service',
              '@id': 'https://shark-ai-solutions.com/aiemployees#ai-crm',
              name: 'AI CRM',
          ...
          },
          {
            ...
            itemOffered: {
              '@type': 'Service',
              '@id': 'https://shark-ai-solutions.com/aiemployees#sales-coach',
              name: 'AI Sales Coach',
    ...
    {
      '@type': 'FAQPage',
      '@id': 'https://shark-ai-solutions.com/aiemployees#faq',
      mainEntity: [
        {
          '@type': 'Question',
    ...
    {
      '@type': 'WebPage',
      '@id': 'https://shark-ai-solutions.com/aiemployees',
      url: 'https://shark-ai-solutions.com/aiemployees',
      name: 'AI Employees for Service Businesses | Shark AI Solutions',
