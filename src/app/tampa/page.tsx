    ...
    <>
      ...
      <section className="bg-white min-h-[80vh] flex flex-col items-center justify-center text-center px-6 pt-24 pb-20">
        <div className="max-w-[720px] mx-auto">
          ...
          <h1 className="display-hero text-[#0a0a0a] mb-6" style={{ textWrap: 'balance' }}>
            ...
            <br />
            <span className="text-[#18b5d8]">for Tampa Businesses</span>
          </h1>
          <p className="lead-airy text-[#333333] max-w-[520px] mx-auto mb-12" style={{ textWrap: 'balance' }}>
            When a Tampa customer asks ChatGPT, Google AI Overviews, or Perplexity for a local business recommendation, does your name come up? We make sure it does.
          </p>
      ...
      <section className="bg-white px-6 py-20 border-t border-[#e8e8ed]">
        <div className="max-w-[980px] mx-auto">
          <div className="text-center mb-14">
            <p className="text-[#18b5d8] text-[13px] font-semibold tracking-[0.2em] uppercase mb-5">How We Help Tampa Businesses</p>
            ...
            <p className="text-[16px] text-[#555] mt-5 max-w-[520px] mx-auto">
              Every Tampa business we work with goes through the same proven three-step framework.
            </p>
          </div>
            ...
            {[
              {
                step: '01',
                title: 'AI Audit',
                body: 'We run your Tampa business through ChatGPT, Gemini, Perplexity, Google AI Overviews, and Copilot to find exactly where you\'re invisible, inconsistent, or outranked by local competitors.',
              },
              {
                step: '02',
          ...
          <div className="bg-[#0a0a0a] rounded-[16px] px-8 py-6 text-center">
            <p className="text-[16px] text-white/70">
              Serving Tampa, South Tampa, Downtown, Channelside, Hyde Park, and the greater Tampa Bay area.
            </p>
          </div>
        </div>
      </section>
      ...
      <section className="bg-white px-6 py-20 border-t border-[#e8e8ed]">
        <div className="max-w-[980px] mx-auto">
          <div className="text-center mb-12">
            ...
            <h2 className="display-lg text-[#0a0a0a]" style={{ textWrap: 'balance' }}>
              Tampa businesses across every category.
            </h2>
          </div>
      ...
      <section className="bg-[#0a0a0a] py-28 px-6 text-center">
        <div className="max-w-[560px] mx-auto">
          <p className="text-[13px] font-semibold tracking-[0.2em] uppercase text-[#18b5d8] mb-6">Tampa, FL</p>
          <h2 className="display-lg text-white mb-6" style={{ textWrap: 'balance' }}>
            Start with a free AI Audit for your Tampa business.
          </h2>
