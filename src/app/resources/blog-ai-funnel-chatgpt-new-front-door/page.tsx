...
export default function Page() {
  return (
    ...
    >
      ...
      <p>Why is this happening so fast? Because consumers value their time more than your SEO strategy. Research shows that more than <strong>40% of consumers</strong> now use AI tools for product and service research&mdash;a figure that has roughly doubled year over year since 2023.<sup>1</sup> We&rsquo;ve moved from the &ldquo;Search Era&rdquo; to the &ldquo;Answer Era.&rdquo;</p>
      ...
      <ol>
        ...
        <li><strong>Join a Workshop:</strong> We offer deep dives into the tactics that drive real ROI &mdash; from AI search visibility to reputation management. <a href="/services">Explore our services</a>.</li>
      ...
      <p style={{ fontSize: "0.8rem", color: "#999", lineHeight: "1.6" }}>
        <sup>1</sup> McKinsey &amp; Company, &ldquo;The State of AI&rdquo; (2024) &mdash; <a href="https://www.mckinsey.com/capabilities/quantumblack/our-insights/the-state-of-ai" target="_blank" rel="noopener noreferrer">mckinsey.com</a><br />
        <sup>2</sup> OpenAI, &ldquo;ChatGPT reaches 400 million weekly users&rdquo; (Feb 2025) &mdash; <a href="https://openai.com/index/400-million-users/" target="_blank" rel="noopener noreferrer">openai.com</a>
      </p>
    </BlogShell>
  );
}
