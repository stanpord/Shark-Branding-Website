...
export default function Page() {
 return (
  ...
  >
   ...
   <p>The <strong>24-Hour Rule</strong> is simple: Every review, whether it&rsquo;s a 5-star rave or a 1-star disaster, needs a thoughtful response within one business day.</p>
   ...
   <p style={{ fontSize: "0.8rem", color: "#999", lineHeight: "1.6" }}>
    <sup>1</sup> BrightLocal, &ldquo;Local Consumer Review Survey&rdquo; (2024), see <a href="https://www.brightlocal.com/research/local-consumer-review-survey/" target="_blank" rel="noopener noreferrer">brightlocal.com/research/local-consumer-review-survey</a><br />
    <sup>2</sup> Google Business Profile Help, &ldquo;Reply to reviews&rdquo;, see <a href="https://support.google.com/business/answer/3474050" target="_blank" rel="noopener noreferrer">support.google.com/business/answer/3474050</a><br />
    <sup>3</sup> Google Search Central, &ldquo;What is E-E-A-T?&rdquo;, see <a href="https://developers.google.com/search/docs/fundamentals/creating-helpful-content" target="_blank" rel="noopener noreferrer">developers.google.com/search/docs/fundamentals/creating-helpful-content</a>
   </p>
  </BlogShell>
 );
}
