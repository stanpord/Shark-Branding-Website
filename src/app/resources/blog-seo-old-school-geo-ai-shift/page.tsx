...
export default function Page() {
 return (
  ...
  >
   <p>Remember the good old days? You&rsquo;d type a few keywords into Google, scroll past three ads, and click on the first organic link. It was a simpler time. But if you&rsquo;re still running your visibility strategy like it&rsquo;s 2019, you&rsquo;re not just behind the curve, you&rsquo;re basically trying to win a NASCAR race on a tricycle.</p>
   ...
   <p>In the eyes of an AI, your business is an &ldquo;Entity.&rdquo; The goal of GEO is to connect your entity to as many positive signals as possible, social media, Google Business Profile, local directories, and press mentions.</p>
