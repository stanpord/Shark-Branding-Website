    ...
    <>
      ...
      <section className="bg-white py-20 px-6">
        <div className="max-w-[980px] mx-auto">
          ...
          <p className="text-center mt-8">
            <a href="/case-studies" className="text-[#18b5d8] text-[14px] font-semibold hover:underline">
      ...
      <section className="bg-[#0a0a0a] py-20 px-6">
        <div className="max-w-[760px] mx-auto">
          <div className="text-center mb-12">
            <p className="text-[#18b5d8] text-[13px] font-semibold tracking-[0.2em] uppercase mb-4">Chamber Member Pricing</p>
            <h2 className="display-lg text-white mb-4" style={{ textWrap: "balance" }}>
              Exclusive rates for chamber members.
            </h2>
            <p className="text-white/50 text-[15px]" style={{ textWrap: "balance" }}>
              These prices are not published anywhere else. Share this page only with fellow members.
            </p>
          </div>

          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 mb-8">
            {/* 12-month */}
            <div className="bg-[#07141a] rounded-[20px] p-7 border-2 border-[#18b5d8] relative flex flex-col">
              <div className="absolute -top-3.5 left-1/2 -translate-x-1/2">
                <span className="bg-[#18b5d8] text-white text-[10px] font-bold tracking-[0.15em] uppercase px-4 py-1.5 rounded-full whitespace-nowrap">
                  Best Value
                </span>
              </div>
              <span className="font-mono text-[#18b5d8] text-[11px] tracking-[0.22em] uppercase block mb-4 mt-2">
                12-Month Agreement
              </span>
              <div className="flex items-baseline gap-1 mb-2">
                <span className="text-[46px] font-bold text-white leading-none">$397</span>
                <span className="text-[16px] text-white/40">/mo</span>
              </div>
              <p className="text-[13px] text-white/40 mb-6 leading-relaxed">
                Results compound over time. Most clients see measurable ranking movement within 30 days and significant AI visibility gains by month three.
              </p>
              <Link
                href="/contact"
                className="btn-press mt-auto block text-center bg-[#18b5d8] text-white text-[15px] font-semibold rounded-full px-6 py-3.5 hover:bg-[#1ec8ee] motion-safe:transition-colors duration-150 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[#18b5d8] focus-visible:ring-offset-2 focus-visible:ring-offset-[#0a0a0a] [touch-action:manipulation]"
              >
                Claim This Rate — $397/mo
              </Link>
            </div>

            {/* 3-month */}
            <div className="bg-[#07141a] rounded-[20px] p-7 border border-white/8 flex flex-col">
              <span className="font-mono text-[#18b5d8] text-[11px] tracking-[0.22em] uppercase block mb-4">
                3-Month Agreement
              </span>
              <div className="flex items-baseline gap-1 mb-2">
                <span className="text-[46px] font-bold text-white leading-none">$497</span>
                <span className="text-[16px] text-white/40">/mo</span>
              </div>
              <p className="text-[13px] text-white/40 mb-6 leading-relaxed">
                Try it, see results, then decide. Everything included &mdash; no watered-down version. Same service, shorter commitment.
              </p>
              <Link
                href="/contact"
                className="btn-press mt-auto block text-center text-white text-[15px] font-semibold rounded-full px-6 py-3.5 border border-white/20 hover:border-white/50 motion-safe:transition-colors duration-150 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[#18b5d8] focus-visible:ring-offset-2 focus-visible:ring-offset-[#0a0a0a] [touch-action:manipulation]"
              >
                Start 3-Month — $497/mo
              </Link>
            </div>
          </div>
          ...
          <p className="text-center text-[13px] text-white/30">
            ...
            We run the audit and walk you through it on a call — you see exactly where you stand before committing to anything.
          </p>
        </div>
      </section>
